...
class CreateQuizTestQuestionView extends StatefulWidget {
  const CreateQuizTestQuestionView({super.key, required this.cubit});

  final CreateQuizTestCubit cubit;

  @override
  State<CreateQuizTestQuestionView> createState() => _CreateQuizTestQuestionViewState();
}

class _CreateQuizTestQuestionViewState extends State<CreateQuizTestQuestionView> {
