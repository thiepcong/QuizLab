...
class EditEditQuestionView extends StatefulWidget {
  const EditEditQuestionView({
    super.key,
    required this.cubit,
    required this.item,
    required this.index,
  ...
  @override
  State<EditEditQuestionView> createState() => _EditEditQuestionViewState();
}

class _EditEditQuestionViewState extends State<EditEditQuestionView> {
