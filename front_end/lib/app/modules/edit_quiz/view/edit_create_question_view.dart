...
class EditCreateQuestionView extends StatefulWidget {
  const EditCreateQuestionView({super.key, required this.cubit});

  final EditQuizCubit cubit;

  @override
  State<EditCreateQuestionView> createState() => _EditCreateQuestionViewState();
}

class _EditCreateQuestionViewState extends State<EditCreateQuestionView> {
  ...
  Widget _buildPage(BuildContext context) {
    return BlocListener<EditQuizCubit, EditQuizState>(
